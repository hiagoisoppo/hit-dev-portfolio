...
export default function SunIcon() {
  return (
    <div
      className="group/sunglitch hidden h-full w-full items-center justify-center text-transparent
      peer-checked/theme:flex peer-checked/theme:text-inherit"
    >
      {/* BASE GLITCH */}
      <RiSunFill className="absolute z-10 text-inherit drop-shadow-[1px_1px_1px_rgb(19_44_103)] group-hover/sunglitch:animate-[glitch0_700ms_infinite] dark:drop-shadow-[1px_1px_1px_rgb(166_166_166)]" />
      <RiSunFill className="absolute z-0 text-tertiary-100 opacity-0 group-hover/sunglitch:animate-[glitch0_500ms_infinite]" />
      <RiSunFill className="absolute z-0 text-quaternary-100 opacity-0 group-hover/sunglitch:animate-[glitch0_315ms_infinite]" />
      <RiSunFill className="absolute z-0 text-primary-100 opacity-0 group-hover/sunglitch:animate-[glitch0_645ms_infinite]" />
      {/* FIRST GLITCH */}
      <RiSunFill
