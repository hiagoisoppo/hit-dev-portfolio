import { RiCharacterRecognitionLine } from '@remixicon/react'

export default function TextLineIcon() {
  return (
    <div
      className="group/globeglitch1 flex h-full w-full items-center justify-center
      peer-checked/language:hidden peer-checked/language:text-transparent"
    >
      {/* BASE GLITCH */}
      <RiCharacterRecognitionLine className="absolute z-10 text-inherit drop-shadow-[1px_1px_1px_rgb(19_44_103)] group-hover/globeglitch1:animate-[glitch0_700ms_infinite] dark:drop-shadow-[1px_1px_1px_rgb(166_166_166)]" />
      <RiCharacterRecognitionLine className="absolute z-0 text-tertiary-100 opacity-0 group-hover/globeglitch1:animate-[glitch0_500ms_infinite]" />
      <RiCharacterRecognitionLine className="absolute z-0 text-quaternary-100 opacity-0 group-hover/globeglitch1:animate-[glitch0_315ms_infinite]" />
      <RiCharacterRecognitionLine className="absolute z-0 text-primary-100 opacity-0 group-hover/globeglitch1:animate-[glitch0_645ms_infinite]" />
      {/* FIRST GLITCH */}
      ...
      <RiCharacterRecognitionLine
        ...
        "
      />
      <RiCharacterRecognitionLine className="absolute z-20 -translate-y-1 translate-x-1 text-quaternary-100 opacity-0 [clip-path:polygon(0%_0%,100%_0%,100%_45%,0%_45%)] group-hover/globeglitch1:animate-[glitch1_315ms_infinite]" />
      <RiCharacterRecognitionLine
