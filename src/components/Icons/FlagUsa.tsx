...
import FlagUsa from '@/assets/FlagUS.svg'
import Image from 'next/image'

export default function FlagIconUsa() {
  return (
    <div className="group/flagglitch flex h-full w-full items-center justify-center peer-checked/language:hidden">
      {/* BASE GLITCH */}
      <Image
        src={FlagUsa}
