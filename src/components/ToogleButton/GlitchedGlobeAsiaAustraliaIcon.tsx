...
export default function GlitchedGlobeAsiaAustraliaIcon() {
  return (
    <div
      className="group/globeglitch absolute right-2 hidden h-8
    ...
    >
      ...
      <GlobeAsiaAustraliaIcon className="text-tertiary-100 absolute z-0 opacity-0 group-hover/globeglitch:animate-[glitch0_500ms_infinite]" />
      <GlobeAsiaAustraliaIcon className="text-quaternary-100 absolute z-0 opacity-0 group-hover/globeglitch:animate-[glitch0_315ms_infinite]" />
      <GlobeAsiaAustraliaIcon className="text-primary-100 absolute z-0 opacity-0 group-hover/globeglitch:animate-[glitch0_645ms_infinite]" />
      {/* FIRST GLITCH */}
