...
export default function GlitchedGlobeAmericasIcon() {
  return (
    ...
    >
      ...
      <GlobeAmericasIcon className="text-tertiary-100 absolute z-0 opacity-0 group-hover/globeglitch1:animate-[glitch0_500ms_infinite]" />
      <GlobeAmericasIcon className="text-quaternary-100 absolute z-0 opacity-0 group-hover/globeglitch1:animate-[glitch0_315ms_infinite]" />
      <GlobeAmericasIcon className="text-primary-100 absolute z-0 opacity-0 group-hover/globeglitch1:animate-[glitch0_645ms_infinite]" />
      {/* FIRST GLITCH */}
      <GlobeAmericasIcon
      ...
      <GlobeAmericasIcon
        ...
        "
      />
      <GlobeAmericasIcon className="text-quaternary-100 absolute z-20 -translate-y-1 translate-x-1 opacity-0 [clip-path:polygon(0%_0%,100%_0%,100%_45%,0%_45%)] group-hover/globeglitch1:animate-[glitch1_315ms_infinite]" />
      <GlobeAmericasIcon
