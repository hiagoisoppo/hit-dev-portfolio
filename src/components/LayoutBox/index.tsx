...
export default function LayoutBox() {
  ...
  return (
    <motion.div
      ...
      className="fixed h-[97%] w-[95%] bg-primary-700 bg-opacity-15 [clip-path:_polygon(0%_5%,_30%_5%,_35%_0%,_90%_0%,_90%_10%,_100%_15%,_100%_95%,_95.25%_100%,_40%_100%,_35%_94.75%,_0%_94.75%,_0%_5%)] md:h-[98%] md:w-[97%]
